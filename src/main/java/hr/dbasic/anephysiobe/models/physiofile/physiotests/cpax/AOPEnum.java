...
public enum AOPEnum {
    ...
    MOVING_WITHIN_BED_AOP_0("Mobilnost u krevetu (npr. leđa - bok)", 0, "Nemogućnost. Moguće analgosedacija ili paraliza."),
    MOVING_WITHIN_BED_AOP_1("Mobilnost u krevetu (npr. leđa - bok)", 1, "Započinje pokret. Potrebna pomoć dvoje ili više osoba (maksimalno)."),
    MOVING_WITHIN_BED_AOP_2("Mobilnost u krevetu (npr. leđa - bok)", 2, "Započinje pokret. Potrebna pomoć barem jedna osobe (umjereno)."),
    MOVING_WITHIN_BED_AOP_3("Mobilnost u krevetu (npr. leđa - bok)", 3, "Započinje pokret. Potrebna pomoć jedne osobe (minimalno)."),
    MOVING_WITHIN_BED_AOP_4("Mobilnost u krevetu (npr. leđa - bok)", 4, "Postiže samostalnost tijekom više ili točno 3 sekunde."),
    MOVING_WITHIN_BED_AOP_5("Mobilnost u krevetu (npr. leđa - bok)", 5, "Postiže samostalnost u manje od 3 sekunde."),
    ...
    SIT_TO_STAND_AOP_0("Vertikalizacija iz sjedećeg položaja (početna pozicija >= 90° fleksija kuka)", 0, "Nemogućnost/nestabilnost."),
    SIT_TO_STAND_AOP_1("Vertikalizacija iz sjedećeg položaja (početna pozicija >= 90° fleksija kuka)", 1, "Vertikalizacija uz maksimalnu potporu (stajaća dizalica/elevator ili slično)."),
    SIT_TO_STAND_AOP_2("Vertikalizacija iz sjedećeg položaja (početna pozicija >= 90° fleksija kuka)", 2, "Vertikalizacija uz umjerenu pomoć (npr. jedna do dvije osobe)."),
    SIT_TO_STAND_AOP_3("Vertikalizacija iz sjedećeg položaja (početna pozicija >= 90° fleksija kuka)", 3, "Vertikalizacija uz minimalnu potporu (npr. jedna osoba)."),
    SIT_TO_STAND_AOP_4("Vertikalizacija iz sjedećeg položaja (početna pozicija >= 90° fleksija kuka)", 4, "Vertikalizacija gurajući od naslona stolice."),
    SIT_TO_STAND_AOP_5("Vertikalizacija iz sjedećeg položaja (početna pozicija >= 90° fleksija kuka)", 5, "Vertikalizacija bez pomoći aktivacije gornjih ekstremiteta."),
